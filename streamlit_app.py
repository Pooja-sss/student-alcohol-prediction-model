...
if st.button('Predict Alcohol Consumption Level'):
    ...
    input_data = pd.DataFrame([[age, studytime, health, absences, G1, G2, G3]],
                              columns=['age', 'studytime', 'health', 'absences', 'G1', 'G2', 'G3'])
    ...
    if prediction == 0:
        st.write("Predicted Alcohol Consumption (Weekday) level: Class 0")
    else:
        st.write("Predicted Alcohol Consumption (Weekday) level: Class 1")
